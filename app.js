...
function homePage(comando) {
    ...
    this.header = new criarElemento({
        tag: 'div',
        atributos: {
            class: 'bg-dark text-white header-1-0',
        },
    ...
    comando.forEach(function(e, index) {
        ...
        this.img = new criarElemento({
            ...
            css: {
                'width': '100%',
                'border': '0px',
                'height': `${parseInt(window.screen.availWidth * 36.66666666666667 / 100)}px`,
                'border-radius': '0px'
            },
        ...
        for(let i = quantidade; i < delimitar; i++) {
            if(i < itens.length) {
                ...
                this.img = new criarElemento({
                    ...
                    css: {
                        width: `${(screen.width - (screen.width * 0.0416666666666667)) / 2}px`,
                        'border': '0px',
                        height: `${((screen.width - (screen.width * 0.0416666666666667)) / 2) * 0.7652173913043478}px`,
                        'border-radius': '0px'
                    },
                    parente: this.div.elemento
                })
